...
namespace School_Managment_System
{
    public partial class Tsalary : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into Teachers_Salaries(teacher_id,teacher_name,teacher_salary)values(" + textBox1.Text + ",'" + textBox2.Text + "'," + textBox3.Text + ")", con);
            cmd.ExecuteNonQuery();
